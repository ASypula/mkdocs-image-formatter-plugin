...
URLS_1 = ["(one/two/three.com)", "    (hi/some-hyphen.png)", "\n (with.many.dots/one.jpg)", "**  (url1.png.url2/url3.jpg)"]
TRICKY_1 = ["1hello", "@tag1(url1.png)@one-more-tag&and_word"]
EXP_T_TYPES_TRICKY1 = [[TokenType.T_LITERAL], [TokenType.T_IMAGE_SIZE_TAG, TokenType.T_IMAGE_URL, TokenType.T_IMAGE_SIZE_TAG, TokenType.T_LITERAL]]
...
def test_mix1():
    ...
    expected_types = [TokenType.T_LITERAL, TokenType.T_LITERAL, TokenType.T_IMAGE_SIZE_TAG, TokenType.T_IMAGE_SIZE_TAG, TokenType.T_IMAGE_URL]
...
@pytest.mark.parametrize("text, exp_t_types, exp_t_strings", combine(TRICKY_1, EXP_T_TYPES_TRICKY1, EXP_T_STRINGS_TRICKY1))
